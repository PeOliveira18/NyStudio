...
function Sobre() {
    ...
    return (  
        <div className="flex flex-col" data-aos="fade-zoom-on">
            <div className="flex flex-col min-h-screen w-full bg-cover bg-center text-white " style={{backgroundImage: `url(${foto})`}}>
                <Header/>
            ...
            <FotoTexto showBtn title="Uma abordagem moderna" subtitle="É muito importante que os nossos clientes recebam sugestões personalizadas dos médicos mais adequados. Portanto, desenvolvemos um sistema próprio para atender às necessidades dos nossos pacientes." w={"w-[450px]"} reverse={"flex-row"} image={foto2}/>
