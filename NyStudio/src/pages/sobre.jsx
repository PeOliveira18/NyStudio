    ...
    return (  
        <div className="flex flex-col">
            <div className="flex flex-col h-screen w-full bg-cover bg-center text-white" style={{backgroundImage: `url(${foto})`}}>
                <Header/>
                <div className="flex m-auto max-w-[510px] text-center">
                    <h1 className="text-5xl">Queremos que você receba os cuidados que merece.</h1>
                </div>
            </div>
            ...
            <FotoTexto showBtn title="Uma abordagem moderna" subtitle="É muito importante que os nossos clientes recebam sugestões personalizadas dos médicos mais adequados. Portanto, desenvolvemos um sistema próprio para atender às necessidades dos nossos pacientes." w={"w-[400px]"} image={foto2}/>
            <h1 className="m-auto text-5xl mt-20">Nossos valores</h1>
