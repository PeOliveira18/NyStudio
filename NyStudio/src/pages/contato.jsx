...
function Contato() {
    ...
    return (  
        <div>
            <Header/>
            <div className="grid grid-cols-2 mt-36 justify-center h-screen" data-aos="fade-zoom-on">
                    ...
                    <form action="">
                        <div className="flex gap-3">
                            <div>
                                ...
                                <input type="text" className="forms h-12 w-[250px]"/>
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <input type="email" className="forms h-12"/>
                        </div>
                        <div>
                            <label htmlFor="">Mensagem</label>
                            <textarea name="" id="" className="forms" rows="5"></textarea>
                        </div>
                        <div>
